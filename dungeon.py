...
class Dungeon:
    ...
    def build_maze(self):
        ...
        self.__maze[2][2].set_exit()

        # set Pit
        self.__maze[1][1].set_pit()
        self.__maze[1][2].set_pit()
        # self.__maze[2][1].set_pit()

        # set doors
        self.__maze[0][0].set_door_N()
        self.__maze[0][0].set_door_E()
        self.__maze[0][0].set_door_W()
        self.__maze[0][0].set_door_S()

        self.__maze[1][0].set_door_N()
        self.__maze[1][0].set_door_E()
        self.__maze[1][0].set_door_W()
        self.__maze[1][0].set_door_S()


        # set pillars
        self.__maze[0][0].set_pillar_P()
        self.__maze[1][0].set_pillar_P()
