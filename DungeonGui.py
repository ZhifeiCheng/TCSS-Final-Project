...
5) North/ South Doors are Green
6) East / West Doors are Blue
7) No door means a closed wall
8) If there are two adjacent doors, a path exists between rooms.
9) The final score and the pillars picked are displayed at the end of the game.
...
class DungeonGui(object):
    ...
    def __init__(self,num_rows, num_cols):
        global nrows, ncols,row_blank_space,col_blank_space,adventurer, hit_point, pillar_collected, \
            healing_potion_count, vision_potion_count, healing_potion, vision_potion, adv_hit_points, \
            adv_pillar_collected
        """
    ...
    def left(event):
        ...
        """
        global adventurer_i_index, adventurer_j_index, dng, exit_i_index, exit_j_index, nrows, n_cols,\
        ...
        if event.keysym=='Left':
            ...
            DungeonGui.score_card(dng, curr_i, curr_j, next_i, next_j, nrows, ncols)

        if DungeonAdventurer.if_passable(dng,curr_i,curr_j,next_i,next_j,nrows, ncols):
    ...
    def right(event):
        ...
        """
        global adventurer_i_index, adventurer_j_index, dng, exit_i_index, exit_j_index, nrows, ncols,\
            adventurer, hit_point, pillar_collected, healing_potion_count, vision_potion_count, healing_potion,\
            vision_potion
        curr_i = adventurer_i_index
        curr_j = adventurer_j_index
    ...
    def main(self):
        ...
        """
        global my_image, adventurer_i_index, adventurer_j_index, dng, exit_i_index, exit_j_index, nrows, ncols
